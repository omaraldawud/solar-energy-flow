const seoData = {
  ...
  services: {
    ...
    description: "Explore our range of irrigation services including design, installation, maintenance, and repairs for homes and businesses.",
  ...
  contact: {
    ...
    description: "Get in touch for custom irrigation solutions in the Pacific Northwest.",
