            ...
            children: [
              _jsxs(Col, {
                ...
                children: [
                  ...
                  _jsx("p", { children: "Chicago, Illinois. USA. " }),
                  _jsx(FaPhone, {
                    size: 28,
                    className: "me-3",
                    color: "#E3E1A9",
                  ...
                  _jsxs("p", {
                    ...
                    children: [
                      "At ",
                      COMPANY_NAME,
                      ", we provide expert solar panel installation...",
                    ],
                  }),
                ],
              }),
              _jsxs(Col, {
                ...
                children: [
                  _jsx("h5", {
                    ...
                    children: "Solar Energy Services",
                  }),
                  _jsxs(Row, {
                    children: [
                      _jsx(Col, {
                        children: _jsx("ul", {
                          ...
                          children: navLinksResidential.map(({ href, label }) =>
                            _jsx(
                              "li",
                              {
                                children: _jsx("a", {
                                  href: href,
                                  className:
                                    "text-white text-decoration-none hover-gold",
                                  children: label,
                                }),
                              },
                              href
                      ...
                      _jsx(Col, {
                        children: _jsx("ul", {
                          className: "list-styled",
                          children: navLinksCommercial.map(({ href, label }) =>
                            _jsx(
                              "li",
                              {
                                children: _jsx("a", {
              ...
              _jsxs(Col, {
                ...
                children: [
                  ...
                  _jsx("ul", {
                    ...
                    children: navLinksMain.map(({ href, label }) =>
                      _jsx(
                        "li",
                        {
                          children: _jsx("a", {
