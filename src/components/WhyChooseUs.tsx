...
const WhyChooseUs: React.FC = () => {
  ...
  return (
    <Container className="py-5 text-center">
      ...
      <p>Let us now emphasize on the main benefits that customers will get using Pacific Northwest Irrigation.</p>
      <hr  style={{ width: '50%', borderTop: '5px solid #FFFFFF', margin: '1rem auto' }} />
      <Row className="mt-4">
