...
/* -------------------------------------------- */
const Footer = () => {
    return (_jsxs(_Fragment, { children: [_jsx("footer", { style: {
                    backgroundColor: '#161D21',
                }, className: "bg-dark text-white py-5 mt-5", children: _jsx(Container, { children: _jsxs(Row, { children: [_jsxs(Col, { md: 4, className: "mb-3", style: { marginTop: '-40px' }, children: [_jsx("img", { src: "https://solarenergyflow.net/images/solar-energy-flow-tr.png", alt: "Solar Energy Flow Logo", style: { maxWidth: '180px' }, className: "mb-1" }), _jsx("p", { children: "Chicago, Illinois" }), _jsx(FaPhone, { size: 28, className: "me-3", color: '#E3E1A9' }), COMPANY_PHONE, _jsxs("p", { className: "mt-3", style: { color: '#D6D492' }, children: ["At ", COMPANY_NAME, ", we provide expert solar panel installation..."] })] }), _jsxs(Col, { md: 4, className: "mb-3", children: [_jsx("h5", { className: "text-warning", children: "Solar Energy Services" }), _jsxs(Row, { children: [_jsx(Col, { children: _jsx("ul", { className: "list-styled", children: navLinksResidential.map(({ href, label }) => (_jsx("li", { children: _jsx("a", { href: href, className: "text-white text-decoration-none hover-gold", children: label }) }, href))) }) }), _jsx(Col, { children: _jsx("ul", { className: "list-styled", children: navLinksCommercial.map(({ href, label }) => (_jsx("li", { children: _jsx("a", { href: href, className: "text-white text-decoration-none hover-gold", children: label }) }, href))) }) })] })] }), _jsxs(Col, { md: 4, className: "mb-3", children: [_jsx("h5", { className: "text-warning", children: "Stay Connected" }), _jsx(FooterContactInfo, {}), _jsx("ul", { style: {
                                            display: 'flex',
                                            gap: '20px',
                                            paddingLeft: '0',
                                            listStyle: 'none',
