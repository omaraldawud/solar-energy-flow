  ...
  return (
    <div className="space-y-4 text-[#BCBA63]">
      ...
      <div className="flex items-center space-x-2">
        ...
        <span style={{ margin: '20px 0 40px 15px' }}>Mon - Fri: 9:00 AM - 5:00 PM</span>
      </div>
    ...
    <div className="flex items-center space-x-2 my-8" style={{ margin: '40px 0', color: '#BCBA63' }}>
        <p className="text-sm  mb-2">
          Follow us on social media for the latest updates, gardening tips, and exclusive offers.
        </p>
